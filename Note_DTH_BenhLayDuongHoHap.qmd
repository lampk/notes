---
title: "Dịch tễ học bệnh lây qua đường hô hấp"
format: 
  html:
...
```{r, fig.cap="Hình 1. Dây chuyền lây bệnh lây qua đường hô hấp", echo=FALSE}
knitr::include_graphics("figures/DTHBTN_BHH_DCL.png")
```
